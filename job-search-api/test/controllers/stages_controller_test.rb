...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { is_active: @stage.is_active, is_deleted: @stage.is_deleted, name: @stage.name, rank: @stage.rank } }, as: :json
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { is_active: @stage.is_active, is_deleted: @stage.is_deleted, name: @stage.name, rank: @stage.rank } }, as: :json
    assert_response 200
  end
